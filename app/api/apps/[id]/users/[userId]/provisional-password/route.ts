...
// Define uma senha provisória específica (diferente da padrão do app) para um
// AppUser já existente — usado quando o admin quer uma senha só para esse
// usuário, em vez da senha padrão aplicada por /reset-password.
